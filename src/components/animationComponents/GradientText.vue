...
<template>
  <div
    :class="`relative  flex max-w-fit flex-row items-center justify-start rounded-[1.25rem] font-medium backdrop-blur transition-shadow duration-500 overflow-hidden cursor-pointer ${className}`"
  >
    <div
      v-if="showBorder"
