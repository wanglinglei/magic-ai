<template>
  <div class="fixed top-0 left-0 z-50 pointer-events-none">
    <canvas ref="canvasRef" id="fluid" class="w-screen h-screen" />
  </div>
</template>
...
function correctRadius(radius) {
  const aspectRatio = canvasRef.value.width / canvasRef.value.height;
